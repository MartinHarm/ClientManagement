...
public class UserResource {
    ...
    @GetMapping("/users")
    @Timed
    public ResponseEntity<List<UserDTO>> getAllUsers(Pageable pageable, Authentication authentication) {
        final Page<UserDTO> page = userService.getAllManagedUsers(pageable, authentication.getName());
     ...
     *
     * @return the ResponseEntity with status 200 (OK) and with body all countries
     */
    @GetMapping("/countries")
    @Timed
    public ResponseEntity<List<Country>> getAllCountries() {
        final List<Country> countries = userService.getCountries();
