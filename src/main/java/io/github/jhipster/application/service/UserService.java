...
public class UserService {
    ...
    public UserService(UserRepository userRepository, PasswordEncoder passwordEncoder, AuthorityRepository authorityRepository, CountryRepository countryRepository) {
     ...
     */
    public void updateUser(String firstName, String lastName, String email, String langKey, String imageUrl, String countryCode, String address) {
    ...
    public Page<UserDTO> getAllManagedUsers(Pageable pageable, String agent) {
        return userRepository.findAllByCreatedBy(pageable, agent).map(UserDTO::new);
    }
